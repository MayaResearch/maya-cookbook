...
## Known disagreements, checked 2026-09-09
...
3. The independent [LiveKit PR 7175](https://github.com/livekit/agents/pull/7175) is open, not an upstream release. The cookbook pins its tested commit on the public Maya fork's `maya-research-tts` branch, with no dependency on another pending contribution.
